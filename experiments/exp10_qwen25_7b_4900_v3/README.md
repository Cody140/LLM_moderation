# exp10 — Qwen 2.5 7B Instruct (v3 balansēts)
...
```
Balansēts variants — noņemta agresīvā "lean toward safe" instrukcija, pievienoti inline piemēri.
Pilns teksts: benchmark_moderation.py → _QWEN_V3_SYSTEM un _QWEN_CIVIL_V3_TEMPLATE.
```
